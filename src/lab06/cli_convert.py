...
def main():
    ...
    sub = parser.add_subparsers(
        dest="cmd", help="Доступные подкоманды для работы с файлами"
    )
    ...
    p1.add_argument(
        ...
        dest="input",
        required=True,
        help="путь до файла который мы конвертируем",
    )
    p1.add_argument(
        "--out",
        dest="output",
        required=True,
        help="путь до файла куда мы сохраняем конвертированный файл",
    )
    # ========================================================
